...
// Source: internal/repository/messenger_repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/repository/messenger_repository.go -destination=internal/mocks/repository/messenger_repository.go -package=mock_repository
//
...
func (m *MockMessengerRepository) GetAllMessengerRelatedUsers(ctx context.Context, page, pageSize int, orderBy string, userID *int64, chatID *string) ([]*models.MessengerRelatedUser, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllMessengerRelatedUsers", ctx, page, pageSize, orderBy, userID, chatID)
...
func (mr *MockMessengerRepositoryMockRecorder) GetAllMessengerRelatedUsers(ctx, page, pageSize, orderBy, userID, chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllMessengerRelatedUsers", reflect.TypeOf((*MockMessengerRepository)(nil).GetAllMessengerRelatedUsers), ctx, page, pageSize, orderBy, userID, chatID)
}
